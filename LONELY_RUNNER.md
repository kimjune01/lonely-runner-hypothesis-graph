...
## Start with the hypothesis graph

[`hypothesis-graph.md`](hypothesis-graph.md) is the primary research record. It tracks each conjectural step, its dependencies, test, evidence grade, verdict, exact failure when killed, and the successor question it generated. Read it before the supporting artifacts or replay code.
