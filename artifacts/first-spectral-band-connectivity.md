...
| speeds `n` | height | primitive first-band tuples | rank below `n-2` | missing positive tree | signed seed size above 2 |
|---:|---:|---:|---:|---:|---:|
| 3 | 100 | 5 | 0 | 0 | 0 |
| 4 | 35 | 6 | 0 | 0 | 0 |
| 5 | 30 | 8 | 0 | 0 | 0 |
...
Every scanned survivor also has an inclusion-maximal coefficient-two
...
requires three signed dissociated seeds, while the first-band Fibonacci
boundary tuple `(1,2,3,5,8)` still needs only the pair `(1,3)`.
