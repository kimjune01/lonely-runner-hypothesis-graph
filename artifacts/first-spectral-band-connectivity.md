...
this proves H33 completely for `n=3`; unlike the earlier height-100 scan, it is
not merely bounded evidence.
...
remaining complete four-speed H33 domain satisfies

```text
sum_i v_i <= 1000,       gcd(v_i,v_j) <= 2 for every i<j.
```

This is the next exact finite audit target.
